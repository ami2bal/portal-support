        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="admin-navbar">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<%=request.getContextPath()%>/admin-faq">Gestion FAQ</a></li>
                    <li><a href="<%=request.getContextPath()%>/admin-support">Gestion Support</a></li>
                </ul>
...
<jsp:include page="fragment/faq/fragment-admin-faq.jsp"/>
</body>
</html>
